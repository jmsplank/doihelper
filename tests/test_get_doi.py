...
def test_text():
    ...
    expected_text = ("Ng, J., Chen, L. ‐J., Bessho, N., Shuster, J., Burkholder, B., "
                     "& Yoo, J. (2022). Electron‐Scale Reconnection in Three‐"
                     "Dimensional Shock Turbulence. Geophysical Research Letters, "
                     "49(15). Portico. https://doi.org/10.1029/2022gl099544\n")
